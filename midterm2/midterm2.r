...
set.seed(2718)
#w <- <your code here>
w<-sample(rep(seq(1,13),each=4),52)
...
#t <- <your code here>
subset.infant<-infants[infants$martial=="Married" & infants$parity==1, ]
...
# Color the plotting symbol by Species (any 3 colors)
plot(1:nrow(iris),iris$Sepal.Length/iris$Petal.Length,col = iris$Species)
