...
ggplot(wr1500m,aes(year,times_sec))+geom_step(col="blue",lwd=0.5)
...
new_year<-wr1500m$year+wr1500m$month/6
wr1500m<-data.frame(wr1500m,new_year)
# Your qplot command:
qplot(new_year,times_sec,data=wr1500m)+geom_step(col="blue",lwd=0.5)
...
# Your ggplot command:
a<-ggplot(wr1500m,aes(new_year,times_sec))+geom_line()
a+geom_segment(aes(x=wr_1998,y=wr1500m$times_sec[51],xend=2015,yend=wr1500m$times_sec[51]))
...
# Your ggplot command
b<-ggplot(wr1500m,aes(new_year,times_sec))+geom_line()
c<-b+geom_vline(xintercept=c(wr_1944,wr_1998),col=c("green","blue"))
d<-c+geom_text(x=wr_1944,y=wr1500m$times_sec[wr1500m$new_year == wr_1944],label=wr1500m$athlete[wr1500m$new_year == wr_1944],adj=1,cex=3.5,col="green")
e<-d+geom_text(x=wr_1998,y=wr1500m$times_sec[wr1500m$new_year == wr_1998],label=wr1500m$athlete[wr1500m$new_year == wr_1998],adj=1,cex=3.5,col="blue")
print(e)
...
a1<-ggplot(wr1500m,aes(new_year,times_sec),)+geom_line()
b1<-a1+geom_segment(aes(x=wr_1998,y=wr1500m$times_sec[51],xend=2015,yend=wr1500m$times_sec[51]))
c1<-b1+labs(x="Year",y="Record Times (sec)")
e1<-c1+ggtitle("World Records in Men's 1500 meter")
f1<-e1+geom_vline(xintercept=c(wr_1944,wr_1998),col=c("green","blue"))
g1<-f1+geom_text(x=wr_1944,y=wr1500m$times_sec[wr1500m$new_year == wr_1944],label=wr1500m$athlete[wr1500m$new_year == wr_1944],adj=1,cex=3.5,col="green")
h1<-g1+geom_text(x=wr_1998,y=wr1500m$times_sec[wr1500m$new_year == wr_1998],label=wr1500m$athlete[wr1500m$new_year == wr_1998],adj=1,cex=3.5,col="blue")
print(h1)
################################
# PLOT 2
...
ggplot(SO2012Ctry,aes(pop,GDP))+geom_line()
...
qplot(pop,y=GDP_per_person,data=SO2012Ctry,log="xy")+geom_point(aes(size = Total))
...
ggplot()+geom_polygon(data=world_map,aes(x=long,y=lat,group=group),col="grey40",fill="light grey")
...
qplot(longitude,latitude,data=wonMedal)+geom_point(aes(size=Total))
## Not needed
...
ggplot(athletes,aes(Sport,fill=Sex))+geom_bar(width=0.8)
...
# Your ggplot commands
ggplot(athletes,aes(Sport,fill=Sex))+geom_bar(width=0.8)+labs(x="Sports",y="Number of athletes")+ggtitle("Olympic Sport Participation by Gender")
